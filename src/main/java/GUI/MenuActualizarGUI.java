 ...
 * @author Faby
 */
public class MenuActualizarGUI extends javax.swing.JPanel {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(Pastas, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                                .addComponent(Pizzas, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(Faina, javax.swing.GroupLayout.Alignment.LEADING, 0, 0, Short.MAX_VALUE))
                            .addComponent(Milanesas, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(Mila)
                            .addComponent(pizzas1)
                            .addComponent(pastasText))
                        .addGap(98, 98, 98)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(GuarniText, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(Salsas, 0, 117, Short.MAX_VALUE)
                                .addComponent(empanadas, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(SuperEmpanadas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(EmpanadasEspeciales, 0, 0, Short.MAX_VALUE)
                            ...
                            .addComponent(salsasText, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(125, 125, 125)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(PicoteoText, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(Picoteo, 0, 0, Short.MAX_VALUE)
                            .addComponent(InfantilText, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(postresText, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(Licuados, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(Gaseosas, javax.swing.GroupLayout.Alignment.LEADING, 0, 0, Short.MAX_VALUE)
                        .addComponent(Cervezas, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(Postres, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(101, 101, 101))
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private EditarComanda editarComanda;
    // Lista para almacenar los pedidos
    private ArrayList<String> pedido;
    Comanda comanda;
    
    
    public MenuActualizarGUI(JFrame parentFrame, EditarComanda editarComanda, Comanda comanda) {
        this.parentFrame = parentFrame;
        this.editarComanda = editarComanda;
        this.comanda = comanda; // Inicializar comanda
        initComponents();
    ...
    private void addListeners() {
        ...
        Ok.addActionListener(e -> {
            try {
                ...
                Logger.getLogger(MenuActualizarGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    ...
    private void actualizarTextoPedido() {
        ...
        System.out.println("Texto del pedido actualizado: " + pedidoBuilder.toString());
 
    }

    public String guardarPedido() throws Exception {
       
        
        StringBuilder pedidoFinal = new StringBuilder();
if (pedido.isEmpty()) {
            // Si el pedido está vacío, muestra el mensaje directamente
        ...
        if (pedidoFinal.length() > 0) {
            mostrarMensaje("Su pedido fue actualizado: " + pedidoFinal, "Pedido Confirmado", JOptionPane.INFORMATION_MESSAGE);
        } else {
            mostrarMensaje("No se ha seleccionado ningún pedido.", "Error", JOptionPane.ERROR_MESSAGE);
        }

        // Pasar el pedido generado a EditarComanda
        Long idComanda = (comanda != null) ? comanda.getId() : null;
        if (idComanda == null) {
            throw new IllegalStateException("El ID de la comanda es nulo. Verifique el flujo de datos.");
        }
        
        System.out.println(" viendo el pedido de la comanda original" + comanda.getPedido());
        if(comanda.getPedido()==null|| !comanda.getPedido().equals(pedidoFinal.toString())){
         comanda.setPedido(pedidoFinal.toString());
        
        EditarComanda ediComanda = new EditarComanda(parentFrame, idComanda, comanda.getPedido());
        
        parentFrame.getContentPane().removeAll();
        ediComanda.setPreferredSize(new Dimension(1000, 600));
        parentFrame.add(ediComanda, BorderLayout.CENTER);
        parentFrame.pack();
    ...
    private void volverAtras() {
        EditarComanda gc = new EditarComanda(parentFrame);  // Pasamos el objeto GenerarComanda al constructor
        parentFrame.getContentPane().removeAll();
